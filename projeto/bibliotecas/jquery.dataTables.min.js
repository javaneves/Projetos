...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Exibir _MENU_ tutoriais",sZeroRecords:"Nenhum resultado corresponde a sua pesquisa",sEmptyTable:"Não há registros",
sLoadingRecords:"Carregando...",sInfo:"Exibindo _START_ até _END_ de _TOTAL_ tutoriais",sInfoEmpty:"Exibindo 0 to 0 de 0 tutoriais",sInfoFiltered:"(Total de tutoriais: _MAX_)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Procurar:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
